...
$$
\min_{x \in \mathbb{R}^d} \quad \sum_{i=1}^n \left( f_i(x) + g_i(x) \right),
$$
...
For implementation details and example configurations, please refer to the sample notebooks in the [`examples`](./examples/) directory.
